...
if (extension_loaded('newrelic')) {
  newrelic_set_appname('marktopper.com');
}
...
?>
<!DOCTYPE html>
<html lang="en" class="wf-sourcesanspro-n3-active wf-active"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<title>Mark Topper Diderichsen - marktopper.com</title>
...
<script>
  ...
  ga('create', 'UA-45963832-2', 'marktopper.com');
  ga('send', 'pageview');
...
My name is Mark Topper Diderichsen<br>
I'm an <?php echo $age; ?> years old web-developer from Denmark.<br>
I focus on the <a href="https://github.com/marktopper" class="blue" target="_blank">backend-development</a>, as well I really enjoy working with security & scalability.<br>
...
You can see my <a href="https://dribbble.com/webman" class="pink" target="_blank">designs</a> and my previous <a href="https://webman.io/portfolio/" class="orange" target="_blank">projects</a> on my <a href="https://webman.io/resume.pdf" class="blue" target="_blank">life resume</a>.<br>
...
<a class="html5-logo animated bounceInUp" href="http://www.w3.org/html/logo/" target="_blank">
	<p><img src="/img/html5-badge.png" width="63" height="64" alt="HTML5 Powered" title="HTML5 Powered"><span>I have seen the <strong class="orange">future</strong>.<br>
	  It's in my <strong class="orange">browser</strong>!</span></p>
</a>
</div>
<script>
